...
def change_ypred_to_3d(y_pred):
    ...
    :param y_pred: probabilities array of prediction
    :return: array size n*3
    '''
    new_y_pred=[]
    for i in(y_pred):
        pred = np.argsort(i)
...
def change_ypred_1d(y_pred):
    '''
    calc accuracy: predict is true if true in 3 highest
    :param y_pred: array size n*3
    :return: array size n*1
    '''
...
def show_wrong_predicts():
    '''
    show sampels of wrong predicts
    :return: None
    '''
    R = 3
    C = 5
